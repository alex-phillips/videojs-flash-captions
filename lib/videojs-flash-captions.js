(function() {
  function FlashClosedCaptions(options) {
    ...
    var CCButton = videojs.extend(Button, {
      text: "CC",
      constructor: function(name) {
        Component.call(this, name);
    ...
    Button.registerComponent('CCButton', CCButton);
    // (optionally) add the new component as a default player child
    var cc = myvideo.controlBar.addChild('CCButton');
    cc.addClass("icon-closed_caption");
    ...
    cc.on('click', function(e) {
      ...
      if (captionsEnabled) {
        overlay = myvideo.addChild('ClosedCaptionText');
        ...
        myvideo.removeChild('ClosedCaptionText');
        overlay = null;
